package com.lld.interviewquestions.chess.pieces;

import com.lld.interviewquestions.chess.Board;
import com.lld.interviewquestions.chess.Cell;
import com.lld.interviewquestions.chess.enums.PieceColour;
import com.lld.interviewquestions.chess.enums.PieceType;
...
public class Knight extends Piece {
    ...
    public boolean isValidMove(Board board, Cell start, Cell end) {
        ...
        // If the target cell is not L shape to the start cell, then it is invalid move
