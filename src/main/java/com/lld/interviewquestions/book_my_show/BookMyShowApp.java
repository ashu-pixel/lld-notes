package com.lld.interviewquestions.book_my_show;

import java.time.LocalDate;
import java.time.LocalTime;
import java.util.*;

import com.lld.interviewquestions.book_my_show.controllers.BookingController;
import com.lld.interviewquestions.book_my_show.controllers.TheatreController;
import com.lld.interviewquestions.book_my_show.entities.*;
import com.lld.interviewquestions.book_my_show.enums.City;
import com.lld.interviewquestions.book_my_show.enums.SeatCategory;
        ...
        private void userFlow() {
                ...
                Thread user1 = new Thread(() -> {
                        try {
                                ...
                                System.out.println("BOOKING FAILED" + Thread.currentThread().getName());
                        }
